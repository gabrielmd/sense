...
#include "compcxx_mm1-comp.h"
class compcxx_Server_5;
#line 52 "mm1-comp.cc"
...
public:compcxx_Server_5* p_compcxx_Server_5;};

class compcxx_Server_5;/*template <class T> */
...
private:
    CostSimEng* m_simeng;
    event_t m_event;
public:compcxx_Server_5* p_compcxx_parent;};

class compcxx_FIFO_4;class compcxx_FIFOServer_7;
#line 119 "mm1-comp.cc"
/*template <class DATATYPE>
*/
#line 119 "mm1-comp.cc"
class compcxx_Server_5 : public compcxx_component, public TypeII
{
public:
	virtual ~compcxx_Server_5() {}
    double service_time;
...
private:
    packet_t m_packet;
public:compcxx_FIFO_4* p_compcxx_FIFO_4;public:compcxx_FIFOServer_7* p_compcxx_parent;};

class compcxx_Sink_8;
#line 194 "mm1-comp.cc"
/*template < class DATATYPE >
*/
#line 194 "mm1-comp.cc"
class compcxx_FIFOServer_7 : public compcxx_component, public TypeII
{
public:
	compcxx_FIFO_4/*<packet_t > */fifo;
	compcxx_Server_5/*<packet_t > */server;

    compcxx_FIFOServer_7();
    virtual ~compcxx_FIFOServer_7();
    void Setup();

    unsigned int queue_length;
    double service_time;

    /*inport */inline void in(packet_t & d);
    /*outport */inline void out(packet_t & d);

public:compcxx_Sink_8* p_compcxx_Sink_8;};


#line 163 "mm1-comp.cc"
...
private:
	packet_t m_packet;
    int m_seq_number;
public:compcxx_FIFOServer_7* p_compcxx_FIFOServer_7;};


#line 236 "mm1-comp.cc"
class compcxx_MM1_9 : public compcxx_component, public CostSimEng
{
public:
    void Setup();
...
private:
    ...
    compcxx_FIFOServer_7 /*<packet_t> */fifo_server;
    compcxx_Sink_8 sink;
};
...
#line 81 "mm1-comp.cc"
/*template < class DATATYPE >
*/void compcxx_FIFO_4 /*<packet_t > */:: Start()
{
    m_busy=false;
}
...
#line 87 "mm1-comp.cc"
/*template < class DATATYPE >
*/void compcxx_FIFO_4/*<packet_t >*/::in(packet_t & packet)
{
    if (!m_busy)
    { 
        (p_compcxx_Server_5->in(packet));
        m_busy=true;
    } 
...
#line 102 "mm1-comp.cc"

#line 102 "mm1-comp.cc"
/*template < class DATATYPE >
*/void compcxx_FIFO_4 /*<packet_t > */:: next()
{
    if (m_queue.size()>0)
    {
        (p_compcxx_Server_5->in(m_queue.front()));
        m_queue.pop_front();
    } 
    else
    {
...
#line 140 "mm1-comp.cc"
compcxx_Server_5
#line 139 "mm1-comp.cc"
/*template <class DATATYPE>
*//*<DATATYPE>*/::compcxx_Server_5()
{
    wait.p_compcxx_parent=this /*connect wait.to_component,*/;
}


#line 145 "mm1-comp.cc"

#line 145 "mm1-comp.cc"
/*template <class DATATYPE>
*/void compcxx_Server_5/*<packet_t > */:: in(packet_t & packet)
{
    m_packet=packet;
...
#line 153 "mm1-comp.cc"

#line 153 "mm1-comp.cc"
/*template <class DATATYPE>
*/void compcxx_Server_5 /*<packet_t > */:: depart(trigger_t&)
{
    (p_compcxx_parent->out(m_packet));
    (p_compcxx_FIFO_4->next());
    return;
}
...
#line 208 "mm1-comp.cc"
inline void compcxx_FIFOServer_7::in(packet_t & d){return (fifo.in(d));}
#line 209 "mm1-comp.cc"
inline void compcxx_FIFOServer_7::out(packet_t & d){return (p_compcxx_Sink_8->in(d));}
#line 214 "mm1-comp.cc"
compcxx_FIFOServer_7 
#line 213 "mm1-comp.cc"
/*template < class DATATYPE >
*//*<DATATYPE> */:: compcxx_FIFOServer_7()
{
	 /*connect ,fifo.in*/;
	fifo.p_compcxx_Server_5=&server /*connect fifo.out,server.in*/;
	server.p_compcxx_FIFO_4=&fifo /*connect server.next, fifo.next*/;
	server.p_compcxx_parent=this /*connect server.out,*/;
}


#line 223 "mm1-comp.cc"
compcxx_FIFOServer_7 
#line 222 "mm1-comp.cc"
/*template < class DATATYPE >
*//*<DATATYPE> */:: ~compcxx_FIFOServer_7()
{
}
...
#line 227 "mm1-comp.cc"

#line 227 "mm1-comp.cc"
/*template < class DATATYPE >
*/void compcxx_FIFOServer_7 /*<packet_t > */:: Setup()
{
...
#line 185 "mm1-comp.cc"
void compcxx_Sink_8::in(packet_t &packet)
{
    m_packet=packet;
...
#line 252 "mm1-comp.cc"
void compcxx_MM1_9::Setup()
{
    ...
    source.p_compcxx_FIFOServer_7=&fifo_server /*connect source.out,fifo_server.in*/;
    fifo_server.p_compcxx_Sink_8=&sink /*connect fifo_server.out,sink.in*/;
}


#line 263 "mm1-comp.cc"
