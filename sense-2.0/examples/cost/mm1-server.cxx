...
#include "compcxx_mm1-server.h"
class compcxx_FIFOServer_5;/*template <class T> */
...
private:
    CostSimEng* m_simeng;
    event_t m_event;
public:compcxx_FIFOServer_5* p_compcxx_parent;};

class compcxx_Sink_6;
#line 52 "mm1-server.cc"
/*template < class DATATYPE >
*/
#line 52 "mm1-server.cc"
class compcxx_FIFOServer_5 : public compcxx_component, public TypeII
{
public:
    compcxx_FIFOServer_5();
    virtual ~compcxx_FIFOServer_5();
    void Start();
...
private:
    ...
    packet_t m_packet;
public:compcxx_Sink_6* p_compcxx_Sink_6;};


#line 127 "mm1-server.cc"
class compcxx_Sink_6 : public compcxx_component, public TypeII
{
public:
    /*inport */inline void in(packet_t&);
...
class compcxx_FIFOServer_5;
#line 12 "mm1-server.cc"
...
private:
	packet_t m_packet;
    int m_seq_number;
public:compcxx_FIFOServer_5* p_compcxx_FIFOServer_5;};


#line 160 "mm1-server.cc"
class compcxx_MM1_7 : public compcxx_component, public CostSimEng
{
public:
    void Setup();
...
private:
    ...
    compcxx_FIFOServer_5 /*<packet_t> */fifo_server;
    compcxx_Sink_6 sink;
};
...
#line 76 "mm1-server.cc"
compcxx_FIFOServer_5 
#line 75 "mm1-server.cc"
/*template < class DATATYPE >
*//*<DATATYPE> */:: compcxx_FIFOServer_5()
{
	wait.p_compcxx_parent=this /*connect wait.to_component,*/;
}


#line 82 "mm1-server.cc"
compcxx_FIFOServer_5 
#line 81 "mm1-server.cc"
/*template < class DATATYPE >
*//*<DATATYPE> */:: ~compcxx_FIFOServer_5()
{
}
...
#line 86 "mm1-server.cc"

#line 86 "mm1-server.cc"
/*template < class DATATYPE >
*/void compcxx_FIFOServer_5 /*<packet_t > */:: Start()
{
    m_busy=false;
}


#line 92 "mm1-server.cc"

#line 92 "mm1-server.cc"
/*template < class DATATYPE >
*/void compcxx_FIFOServer_5/*<packet_t >*/::in(packet_t & packet)
{
    if (!m_busy)
    { 
	    m_packet=packet;
...
#line 108 "mm1-server.cc"

#line 108 "mm1-server.cc"
/*template <class DATATYPE>
*/void compcxx_FIFOServer_5 /*<packet_t > */:: depart(trigger_t&)
{
    (p_compcxx_Sink_6->in(m_packet));
    if (m_queue.size()>0)
    {
...
#line 149 "mm1-server.cc"
void compcxx_Sink_6::in(packet_t &packet)
{
    m_packet=packet;
...
#line 23 "mm1-server.cc"

#line 30 "mm1-server.cc"
...
void compcxx_Source_4::create(trigger_t&)
{
    ...
    (p_compcxx_FIFOServer_5->in(m_packet));
    return;
}
...
#line 176 "mm1-server.cc"
void compcxx_MM1_7::Setup()
{
    source.interval=interval;
    fifo_server.queue_length=queue_length;
    fifo_server.service_time=service_time;

    source.p_compcxx_FIFOServer_5=&fifo_server /*connect source.out,fifo_server.in*/;
    fifo_server.p_compcxx_Sink_6=&sink /*connect fifo_server.out,sink.in*/;
}


#line 186 "mm1-server.cc"
