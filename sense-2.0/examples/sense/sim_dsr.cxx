...
typedef DSRI_Struct<app_packet_t>::packet_t net_packet_t;
...
public:
    ...
    void Start();
    void Stop();
public:compcxx_DSRI_16* p_compcxx_DSRI_16;};
...
class compcxx_FIFOACK3_22;class compcxx_DSRI_16;class compcxx_DuplexTransceiver_18;/*template <class PLD>
*/
...
public:compcxx_FIFOACK3_22* p_compcxx_FIFOACK3_22;public:compcxx_DSRI_16* p_compcxx_DSRI_16;public:compcxx_DuplexTransceiver_18* p_compcxx_DuplexTransceiver_18;};
...
/*template <class T> */
#line 388 "../../common/cost.h"
class compcxx_InfiTimer_6 : public compcxx_component, public TimerBase
{
public:
    struct event_t : public CostEvent { pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  data; };
    compcxx_InfiTimer_6();
	virtual ~compcxx_InfiTimer_6();
	
	/*outport void to_component(pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  &, unsigned int i)*/;
	
    void activate(CostEvent*event);

    inline unsigned int Set(double t);
    inline unsigned int Set( pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  const & data, double t);
    inline void Cancel (unsigned int index);
    inline event_t* GetEvent(unsigned int index);

    inline bool Active(unsigned int index) { return GetEvent(index)->active; }
    inline double GetTime(unsigned int index) { return GetEvent(index)->time; }
    inline pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  & GetData(unsigned int index) { return GetEvent(index)->data; }
    inline void SetData(pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  const &d, unsigned int index) { GetEvent(index)->data = d; }
 ...
 private:
    ...
    CorsaAllocator* m_allocator;
public:compcxx_DSRI_16* p_compcxx_parent;};

class compcxx_CBR_15;class compcxx_FIFOACK3_22;/*template <class PLD>
*/
#line 91 "../../net/dsri.h"
class compcxx_DSRI_16 : public compcxx_component, public TypeII, public DSRI_Struct<app_packet_t >
{
public:
	...
	compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t >::packet_t*,ether_addr_t> > */to_mac_delay;
    ...
    compcxx_DSRI_16() { to_mac_delay.p_compcxx_parent=this /*connect to_mac_delay.to_component, */;  }
    virtual ~compcxx_DSRI_16() {};
    void Start();
    void Stop();
...
protected:
    ...
    rreq_table_t rreq_table; 
    cache_table_t m_cache;  
    int m_rreq_id;
...
class compcxx_MAC80211_17;class compcxx_DSRI_16;/*template < class T1, class T2, class T3 >
*/
...
public:compcxx_MAC80211_17* p_compcxx_MAC80211_17;public:compcxx_DSRI_16* p_compcxx_DSRI_16;};
...
public:
    ...
    compcxx_CBR_15 app;
    compcxx_DSRI_16 /*<app_packet_t> */net;
...
void compcxx_CBR_15::create(trigger_t&, int index)
{
    ...
    (p_compcxx_DSRI_16->from_transport(p,p.dst_addr,p.data_size));
    SentPackets++;
...
*/void compcxx_MAC80211_17/*<net_packet_t* >*/::RecvData(packet_t* p)
{
    ...
    (p_compcxx_DSRI_16->from_mac_data(p->pld,p->hdr.dh_da));
    p->free(); 
}
...
#line 435 "../../common/cost.h"
/*template <class T>
*//*typename */compcxx_InfiTimer_6/*<T>*/::event_t* compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::GetEvent(unsigned int index)
{
   	if (index>=m_events.size())
   	{
        for (unsigned int i=m_events.size();i<=index;i++)
...
#line 451 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::Set(pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  const & data, double time)
{
	int index=GetSlot();
    event_t * e = GetEvent(index);
    assert(e->active==false);
...
#line 465 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::Set(double time)
{
	int index=GetSlot();
    event_t * e = GetEvent(index);
    assert(e->active==false);
...
#line 478 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::Cancel(unsigned int index)
{
    event_t * e = GetEvent(index);
    assert(e->active);
   	m_simeng->CancelEvent(e);
...
#line 488 "../../common/cost.h"
/*template <class T>
*/void compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::activate(CostEvent*e)
{
	event_t * event = (event_t*)e;
	event->active = false;
   	ReleaseSlot(event->index);
...
#line 497 "../../common/cost.h"
/*template <class T>
*/unsigned int compcxx_InfiTimer_6/*<pair<DSRI_Struct<app_packet_t>::packet_t*,ether_addr_t>  >*/::GetSlot()
{
    if(m_free_slots.empty())GetEvent(m_events.size()*2-1);
    int i=m_free_slots.back();
    m_free_slots.pop_back();
...
#line 101 "../../net/dsri.h"
void compcxx_DSRI_16::to_transport( payload_t& pld ){return (p_compcxx_CBR_15->from_transport( pld ));}
#line 102 "../../net/dsri.h"
void compcxx_DSRI_16::to_mac(packet_t* pkt, ether_addr_t& dst, unsigned int size){return (p_compcxx_FIFOACK3_22->in(pkt,dst,size));}
#line 104 "../../net/dsri.h"
...
#line 134 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::Start() 
{	
    m_rreq_id=0;
    SentPackets=RecvPackets=0;
}
...
#line 141 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::Stop() 
{
...
#line 150 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::from_transport( payload_t& pld, ether_addr_t& dst_addr, unsigned int size)
{
    ...
    
    {
    	...
    	SentPackets++;
	    (p_compcxx_FIFOACK3_22->in(new_p, new_p->hdr.srcrt.get_addr(0), new_p->hdr.size));
    }  
    else 
    {
...
#line 178 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::from_mac_ack (bool)
{
}	
...
#line 183 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::from_mac_data (packet_t* packet, ether_addr_t& dst_addr)
{
...
#line 207 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::receive_data(packet_t* p)
{
    if(p->hdr.dst_addr == MyEtherAddr)  
    {
	    p->inc_pld_ref();
	    (p_compcxx_CBR_15->from_transport(p->pld));
	return;
    }
    ...
    new_p->hdr.srcrt.shift_copy(p->hdr.srcrt); 
    p->inc_pld_ref();
    new_p->pld = p->pld;
    SentPackets++;
    (p_compcxx_FIFOACK3_22->in(new_p, new_p->hdr.srcrt.get_addr(0), new_p->hdr.size));
...
#line 230 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::init_rreq(ether_addr_t dst)
{
    packet_t* new_p = packet_t::alloc();
    new_p->hdr.type = RREQ;
    ...
    new_p->hdr.srcrt.clear();  
    new_p->hdr.srcrt.append(MyEtherAddr);
    new_p->hdr.size= RREQ_SIZE + new_p->hdr.srcrt.get_size();
    new_p->hdr.rreq_id=++m_rreq_id;  
    rreq_table[MyEtherAddr]=m_rreq_id;  
    SentPackets++;
    (p_compcxx_FIFOACK3_22->in(new_p, ether_addr_t::BROADCAST,new_p->hdr.size));
}
...
#line 248 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::receive_rreq(packet_t* p)
{
...
#line 295 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::init_rrep(packet_t* p)
{
    packet_t* new_p = packet_t::alloc();
    new_p->hdr.type = RREP;
    ...
    SentPackets++;
    (p_compcxx_FIFOACK3_22->in(new_p, new_p->hdr.srcrt.get_addr(p->hdr.srcrt.get_hops()-1),new_p->hdr.size)); 
}
...
#line 310 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::receive_rrep(packet_t* p)
{
    ether_addr_t myaddr=MyEtherAddr;
    ...
    if(myaddr!=p->hdr.dst_addr) 
    {
	    ...
	    assert(index>0);
	    SentPackets++;
	    (p_compcxx_FIFOACK3_22->in(new_p, new_p->hdr.srcrt.get_addr(index-1), new_p->hdr.size));
    }    
    else
    {
	    assert(index==0);
...
#line 366 "../../net/dsri.h"
/*template <class PLD>
*/void compcxx_DSRI_16/*<app_packet_t >*/::to_mac_depart(const pair<packet_t*,ether_addr_t>&p, unsigned int i)
{
	(p_compcxx_FIFOACK3_22->in(p.first,p.second,p.first->hdr.size));
}
...
*/void compcxx_FIFOACK3_22 /*<net_packet_t* ,ether_addr_t ,unsigned int >*/::in (net_packet_t* const& t1, ether_addr_t const& t2, unsigned int const& t3)
{
    ...
    (p_compcxx_DSRI_16->from_mac_ack(true));
    return;
}
...
void compcxx_SensorNode_23::Setup()
{
    ...
    app.p_compcxx_DSRI_16=&net /*connect app.to_transport, net.from_transport*/;
    ...
    queue.p_compcxx_DSRI_16=&net /*connect queue.ack, net.from_mac_ack*/;
    mac.p_compcxx_DSRI_16=&net /*connect mac.to_network_data, net.from_mac_data */;
