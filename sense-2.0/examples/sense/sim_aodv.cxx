...
public:
    ...
    void Start();
    void Stop();
public:compcxx_AODVI_16* p_compcxx_AODVI_16;};
...
class compcxx_FIFOACK3_22;class compcxx_AODVI_16;class compcxx_DuplexTransceiver_18;/*template <class PLD>
*/
...
public:compcxx_FIFOACK3_22* p_compcxx_FIFOACK3_22;public:compcxx_AODVI_16* p_compcxx_AODVI_16;public:compcxx_DuplexTransceiver_18* p_compcxx_DuplexTransceiver_18;};
...
public:
 ...
 private:
    ...
    CorsaAllocator* m_allocator;
public:compcxx_AODVI_16* p_compcxx_parent;};

class compcxx_CBR_15;class compcxx_FIFOACK3_22;/*template <class PLD>
*/
#line 109 "../../net/aodvi.h"
class compcxx_AODVI_16 : public compcxx_component, public TypeII, public AODVI_Struct<app_packet_t >
{
public:
    ...
    compcxx_AODVI_16() { to_mac_delay.p_compcxx_parent=this /*connect to_mac_delay.to_component, */;  }
    virtual ~compcxx_AODVI_16() {};
    void Start();				        
    void Stop();				        
...
class compcxx_MAC80211_17;class compcxx_AODVI_16;/*template < class T1, class T2, class T3 >
*/
...
public:compcxx_MAC80211_17* p_compcxx_MAC80211_17;public:compcxx_AODVI_16* p_compcxx_AODVI_16;};
...
public:
    ...
    compcxx_CBR_15 app;
    compcxx_AODVI_16 /*<app_packet_t> */net;
...
void compcxx_CBR_15::create(trigger_t&, int index)
{
    ...
    (p_compcxx_AODVI_16->from_transport(p,p.dst_addr,p.data_size));
    SentPackets++;
...
*/void compcxx_MAC80211_17/*<net_packet_t* >*/::RecvData(packet_t* p)
{
    ...
    (p_compcxx_AODVI_16->from_mac_data(p->pld,p->hdr.dh_da));
    p->free(); 
}
...
#line 119 "../../net/aodvi.h"
void compcxx_AODVI_16::to_transport( payload_t& pld ){return (p_compcxx_CBR_15->from_transport( pld ));}
#line 120 "../../net/aodvi.h"
void compcxx_AODVI_16::to_mac(packet_t* pkt, ether_addr_t& dst, unsigned int size){return (p_compcxx_FIFOACK3_22->in(pkt,dst,size));}
#line 122 "../../net/aodvi.h"

#line 155 "../../net/aodvi.h"

#line 155 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::Start()
{
    m_seq_num = 0;
    m_req_id = 0;
    SentPackets=RecvPackets=0;
...
#line 163 "../../net/aodvi.h"

#line 163 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::Stop()
{
...
#line 171 "../../net/aodvi.h"

#line 171 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::from_transport( payload_t& pld, ether_addr_t& dst_addr, unsigned int size)
{    
    ...
    else
    {
	    ...
	    SentPackets++;
	    (p_compcxx_FIFOACK3_22->in(new_p, (iter->second).next_hop, new_p->hdr.size)); 
    } 
} 


#line 201 "../../net/aodvi.h"

#line 201 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::from_mac_ack (bool)
{
}

#line 205 "../../net/aodvi.h"

#line 205 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::from_mac_data (packet_t* packet, ether_addr_t& dst_addr)
{
    if(dst_addr==MyEtherAddr||dst_addr==ether_addr_t::BROADCAST)
    {
	    RecvPackets++;
        Printf((DumpPackets,"aodv%d received %s\n",(int)MyEtherAddr, packet->dump().c_str()));
...
#line 229 "../../net/aodvi.h"

#line 229 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::receive_data(packet_t* p)
{
...
#line 263 "../../net/aodvi.h"

#line 263 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::init_rreq(ether_addr_t dst)
{
    packet_t* new_p = packet_t::alloc();
...
#line 302 "../../net/aodvi.h"

#line 302 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::receive_rreq(packet_t* p)
{
    ...
    if(MyEtherAddr == dst)
    {
	    ...
	    SentPackets++;
	    (p_compcxx_FIFOACK3_22->in(new_p, rv_iter->second.next_hop, new_p->hdr.size));
    }
    else
    {
...
#line 434 "../../net/aodvi.h"

#line 434 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::forward_rreq(packet_t* p, int max_seq_num)
{
    if(p->hdr.TTL > 1) 
    {
	    packet_t* new_p = packet_t::alloc();
...
#line 456 "../../net/aodvi.h"

#line 456 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::receive_rrep(packet_t* p)
{
    ...
    if(fw_iter == m_routing_table.end())
    {
	    ...
	    while(iter!=m_packet_buffer.end())
	    {
	        ...
	        if((*curr)->hdr.dst_addr==p->hdr.src_addr)
	        {
		        ...
		        SentPackets++;
	            (p_compcxx_FIFOACK3_22->in(*curr, fw_iter->second.next_hop, (*curr)->hdr.size));
...
#line 555 "../../net/aodvi.h"

#line 555 "../../net/aodvi.h"
/*template <class PLD>
*/void compcxx_AODVI_16/*<app_packet_t >*/::to_mac_depart(const pair<packet_t*,ether_addr_t>&p, unsigned int i)
{
...
*/void compcxx_FIFOACK3_22 /*<net_packet_t* ,ether_addr_t ,unsigned int >*/::in (net_packet_t* const& t1, ether_addr_t const& t2, unsigned int const& t3)
{
    ...
    (p_compcxx_AODVI_16->from_mac_ack(true));
    return;
}
...
void compcxx_SensorNode_23::Setup()
{
    ...
    app.p_compcxx_AODVI_16=&net /*connect app.to_transport, net.from_transport*/;
    ...
    queue.p_compcxx_AODVI_16=&net /*connect queue.ack, net.from_mac_ack*/;
    mac.p_compcxx_AODVI_16=&net /*connect mac.to_network_data, net.from_mac_data */;
