...
/*******************************************************************
 *  These three lines are commented out.  They are used when 
 *  the net component is directly connected to the mac component
 ...
 * to nodes that cann't detect them.  @RXThresh@ is also needed to produce
 * the same receive power in those nodes that can just correctly recieve packets
