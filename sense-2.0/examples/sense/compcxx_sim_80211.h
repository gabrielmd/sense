...
typedef void  (compcxx_component::*SimpleChannel_to_phy_f_t)(mac_packet_t  * p, double power );
typedef void  (compcxx_component::*SensorNode_to_channel_packet_f_t)(mac_packet_t* packet, double power, int id);
typedef void  (compcxx_component::*SensorNode_to_channel_pos_f_t)(coordinate_t& pos, int id);
};
