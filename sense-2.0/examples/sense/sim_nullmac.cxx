...
class compcxx_SimpleChannel_20;
...
public:compcxx_SimpleChannel_20* p_compcxx_parent;};

/*template <class PACKET>

*/
#line 28 "../../phy/simple_channel.h"
class compcxx_SimpleChannel_20 : public compcxx_component, public TypeII
{
 public:
    ...
    compcxx_SimpleChannel_20() { propagation_delay.p_compcxx_parent=this /*connect propagation_delay.to_component, */; }
    virtual ~compcxx_SimpleChannel_20() {}
    void Start();
    void Stop();
    void Setup();
...
class compcxx_RandomNeighbor_13;/*template <class T> */
...
private:
    CostSimEng* m_simeng;
    event_t m_event;
public:compcxx_RandomNeighbor_13* p_compcxx_parent;};
...
class compcxx_NullMAC_15;
#line 44 "../../app/random_neighbor.h"
class compcxx_RandomNeighbor_13 : public compcxx_component, public TypeII, public RandomNeighbor_Struct
{
public:
    ...
    compcxx_RandomNeighbor_13();
    virtual ~compcxx_RandomNeighbor_13() ;
    void Start();
    void Stop();
...
public:compcxx_NullMAC_15* p_compcxx_NullMAC_15;};


#line 27 "../../energy/battery.h"
class compcxx_SimpleBattery_17 : public compcxx_component, public TypeII
{
 public:
...
class compcxx_RandomNeighbor_13;class compcxx_DuplexTransceiver_16;/*template <class PLD>
*/
#line 112 "../../mac/null_mac.h"
class compcxx_NullMAC_15 : public compcxx_component, public TypeII, public NullMAC_Struct <RandomNeighbor_Struct::packet_t >
{
 public:
...
public:compcxx_RandomNeighbor_13* p_compcxx_RandomNeighbor_13;public:compcxx_DuplexTransceiver_16* p_compcxx_DuplexTransceiver_16;};
class compcxx_Immobile_14;/*template <class T> */
#line 228 "../../common/cost.h"
...
private:
    CostSimEng* m_simeng;
    event_t m_event;
public:compcxx_Immobile_14* p_compcxx_parent;};

class compcxx_SensorNode_19;
#line 27 "../../mob/immobile.h"
class compcxx_Immobile_14 : public compcxx_component, public TypeII
{
public:
	...
	compcxx_Immobile_14 () { timer.p_compcxx_parent=this /*connect timer.to_component, */; }
    void Start();
    void Stop();
public:compcxx_SensorNode_19* p_compcxx_parent;};
class compcxx_NullMAC_15;class compcxx_SensorNode_19;class compcxx_PowerManager_18;/*template <class PACKET>
*/
#line 34 "../../phy/transceiver.h"
class compcxx_DuplexTransceiver_16  : public compcxx_component, public TypeII
{
 public:
...
public:compcxx_NullMAC_15* p_compcxx_NullMAC_15;public:compcxx_SensorNode_19* p_compcxx_parent;public:compcxx_PowerManager_18* p_compcxx_PowerManager_18;};

class compcxx_SimpleBattery_17;
#line 11 "../../energy/power.h"
class compcxx_PowerManager_18 : public compcxx_component, public TypeII, public PM_Struct
{
public:
 ...
 private:
    int m_state; 
public:compcxx_SimpleBattery_17* p_compcxx_SimpleBattery_17;};


#line 18 "sim_80211.cc"
class compcxx_SensorNode_19 : public compcxx_component, public TypeII
{
public:

    compcxx_RandomNeighbor_13 app;
    compcxx_Immobile_14 mob;
    compcxx_NullMAC_15 /*<RandomNeighbor_Struct::packet_t> */mac;
    compcxx_DuplexTransceiver_16 /*< mac_packet_t > */phy;
    compcxx_SimpleBattery_17 battery;
    compcxx_PowerManager_18 pm;
    ...
    compcxx_SensorNode_19();
    virtual ~compcxx_SensorNode_19();
    void Start();
    void Stop();
    void Setup();
...
#line 114 "sim_80211.cc"
class compcxx_Sim_80211_21 : public compcxx_component, public CostSimEng
{
public:
    ...
    compcxx_array<compcxx_SensorNode_19  >nodes;
    compcxx_SimpleChannel_20 /*< mac_packet_t > */channel;
...
#line 59 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_20/*<mac_packet_t  >*/::Setup()
{
...
#line 67 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_20/*<mac_packet_t  >*/::Start()
{
}
...
#line 71 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_20/*<mac_packet_t  >*/::Stop()
{
}
...
#line 76 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_20/*<mac_packet_t  >*/::pos_in(const coordinate_t & pos, int id)
{
    m_positions[id]=pos;
}
...
#line 82 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_20/*<mac_packet_t  >*/::from_phy ( mac_packet_t  * p, double power, int in)
{
...
#line 113 "../../phy/simple_channel.h"
/*template <class PACKET>
*/void compcxx_SimpleChannel_20/*<mac_packet_t  >*/::depart ( const triple<mac_packet_t  *, double, int> & data , unsigned int index)
{
...
compcxx_RandomNeighbor_13::compcxx_RandomNeighbor_13()
{
...
void compcxx_RandomNeighbor_13::Start()
{
...
void compcxx_RandomNeighbor_13::Stop()
{
...
void compcxx_RandomNeighbor_13::from_transport_ack ( bool flag)
{
...
void compcxx_RandomNeighbor_13::from_transport_data ( packet_t& pld, const ether_addr_t & dst)
{
...
void compcxx_RandomNeighbor_13::BroadcastTimer(trigger_t&)
{
    ...
    (p_compcxx_NullMAC_15->from_network(p,p.dst_addr,p.data_size+2*ether_addr_t::LENGTH));
}

#line 150 "../../app/random_neighbor.h"
void compcxx_RandomNeighbor_13::UnicastTimer(trigger_t&)
{
...
void compcxx_SimpleBattery_17::Start()
{
...
void compcxx_SimpleBattery_17::Stop()
{
}


#line 53 "../../energy/battery.h"
double compcxx_SimpleBattery_17::power_in(double power, simtime_t t)
{
...
double compcxx_SimpleBattery_17::query_in()
{
    return RemainingEnergy;
}
...
#line 163 "../../mac/null_mac.h"
/*template <class PLD>
*/unsigned int compcxx_NullMAC_15/*<RandomNeighbor_Struct::packet_t >*/::RTSThreshold=0;
...
#line 166 "../../mac/null_mac.h"
/*template <class PLD>
*/void compcxx_NullMAC_15/*<RandomNeighbor_Struct::packet_t >*/::Start()
{
...
#line 172 "../../mac/null_mac.h"
/*template <class PLD>
*/void compcxx_NullMAC_15/*<RandomNeighbor_Struct::packet_t >*/::Stop()
{
}
...
#line 211 "../../mac/null_mac.h"
/*template <class PLD>
*/void compcxx_NullMAC_15/*<RandomNeighbor_Struct::packet_t >*/::from_network(payload_t& pld, const ether_addr_t& dst, unsigned int size)
{
    ...
    (p_compcxx_DuplexTransceiver_16->from_mac(p));                 
    (p_compcxx_RandomNeighbor_13->from_transport_ack(true));      
    SentPackets++;
}
...
#line 236 "../../mac/null_mac.h"
/*template <class PLD>
*/void compcxx_NullMAC_15/*<RandomNeighbor_Struct::packet_t >*/::from_phy(packet_t* pkt, bool errflag, double  power)
{
	RecvPackets++;
    ...
    if(pkt->hdr.dst_addr==MyEtherAddr||pkt->hdr.dst_addr==ether_addr_t::BROADCAST||Promiscuity)
    {
		...
		pkt->inc_pld_ref();
		(p_compcxx_RandomNeighbor_13->from_transport_data(pkt->pld,pkt->hdr.dst_addr));
    }
...
void compcxx_Immobile_14::pos_out(coordinate_t& pos, int id){return (p_compcxx_parent->to_channel_pos(pos,id));}
#line 32 "../../mob/immobile.h"

#line 41 "../../mob/immobile.h"
void compcxx_Immobile_14::announce_pos(trigger_t&)
{
...
void compcxx_Immobile_14::Start()
{
	timer.Set(0.0);
}

#line 50 "../../mob/immobile.h"
void compcxx_Immobile_14::Stop()
{
}
...
#line 67 "../../phy/transceiver.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiver_16/*<mac_packet_t  >*/::Start()
{
}
...
#line 72 "../../phy/transceiver.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiver_16/*<mac_packet_t  >*/::Stop()
{
}
...
#line 77 "../../phy/transceiver.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiver_16/*<mac_packet_t  >*/::from_mac(mac_packet_t  * p)
{
	double now = SimTime();
	if((p_compcxx_PowerManager_18->switch_state(PM_Struct::TX,now))<0.0)  
    {
    	p->free();
		return;
    }	 
   
    if((p_compcxx_PowerManager_18->switch_state(PM_Struct::IDLE,now+p->hdr.tx_time))<0.0)
    {
    	p->free();
    	return;
    } 
...
#line 96 "../../phy/transceiver.h"
/*template <class PACKET>
*/void compcxx_DuplexTransceiver_16/*<mac_packet_t  >*/::from_channel(mac_packet_t  * p, double power)
{
	double now = SimTime();
    if((p_compcxx_PowerManager_18->switch_state(PM_Struct::RX,now))< 0.0)  
    {
       p->free();
       return;
    }
	...
	else
	{
		bool error = ( recv_power < RXThresh ) ;
	  	(p_compcxx_NullMAC_15->from_phy( p, error, recv_power ));
    }
}


#line 33 "../../energy/power.h"
void compcxx_PowerManager_18::Start()
{
    m_state=OFF;
}
...
void compcxx_PowerManager_18::Stop()
{
...
double compcxx_PowerManager_18::switch_state(int state, double time) 
{
    double power=0.0;	
    switch(m_state)
    {
    case TX:
		power = (p_compcxx_SimpleBattery_17->power_in(TXPower,time));
		break;
    case RX:
		power = (p_compcxx_SimpleBattery_17->power_in(RXPower,time));
		break;
    case IDLE:
		power = (p_compcxx_SimpleBattery_17->power_in(IdlePower,time));
		break;
    case SLEEP:
		power = (p_compcxx_SimpleBattery_17->power_in(SleepPower,time));
		break;
    case OFF:
		power = (p_compcxx_SimpleBattery_17->power_in(0.0,time));
		break;
    default:
...
int compcxx_PowerManager_18::state_query()
{
    return m_state; 
}
...
double compcxx_PowerManager_18::energy_query()
{
    return (p_compcxx_SimpleBattery_17->query_in());
}


#line 43 "sim_80211.cc"
void compcxx_SensorNode_19::to_channel_packet(mac_packet_t* packet, double power, int id){return (to_channel_packet_f(packet,power,id));}
#line 44 "sim_80211.cc"
void compcxx_SensorNode_19::from_channel(mac_packet_t* packet, double power){return (phy.from_channel(packet,power));}
#line 45 "sim_80211.cc"
void compcxx_SensorNode_19::to_channel_pos(coordinate_t& pos, int id){return (to_channel_pos_f(pos,id));}
#line 48 "sim_80211.cc"
compcxx_SensorNode_19::compcxx_SensorNode_19()
{
}
...
#line 55 "sim_80211.cc"
void compcxx_SensorNode_19::Start()
{

}


#line 60 "sim_80211.cc"
void compcxx_SensorNode_19::Stop()
{
...
#line 66 "sim_80211.cc"
void compcxx_SensorNode_19::Setup()
{
    ...
    app.p_compcxx_NullMAC_15=&mac /*connect app.to_transport, mac.from_network*/;
    mac.p_compcxx_RandomNeighbor_13=&app /*connect mac.to_network_data, app.from_transport_data*/;
    mac.p_compcxx_RandomNeighbor_13=&app /*connect mac.to_network_ack, app.from_transport_ack*/;

    mac.p_compcxx_DuplexTransceiver_16=&phy /*connect mac.to_phy, phy.from_mac*/;
    phy.p_compcxx_NullMAC_15=&mac /*connect phy.to_mac, mac.from_phy*/;

    phy.p_compcxx_parent=this /*connect phy.to_channel, */;
     /*connect , phy.from_channel*/;
    phy.p_compcxx_PowerManager_18=&pm /*connect phy.to_power_switch, pm.switch_state*/;
    
    pm.p_compcxx_SimpleBattery_17=&battery /*connect pm.to_battery_query, battery.query_in*/;
    pm.p_compcxx_SimpleBattery_17=&battery /*connect pm.to_battery_power, battery.power_in*/;

    mob.p_compcxx_parent=this /*connect mob.pos_out, */;
}


#line 131 "sim_80211.cc"
void compcxx_Sim_80211_21 :: Stop()
{
    int i,sent=0,recv=0;
...
#line 142 "sim_80211.cc"
void compcxx_Sim_80211_21 :: Setup()
{
    int i;
    ...
    for(i=0;i<NumNodes;i++)
    {
		nodes[i].to_channel_packet_f.Connect(channel,(compcxx_component::SensorNode_to_channel_packet_f_t)&compcxx_SimpleChannel_20::from_phy) /*connect nodes[i].to_channel_packet,channel.from_phy*/;
		nodes[i].to_channel_pos_f.Connect(channel,(compcxx_component::SensorNode_to_channel_pos_f_t)&compcxx_SimpleChannel_20::pos_in) /*connect nodes[i].to_channel_pos,channel.pos_in*/;
		channel.to_phy[i].Connect(nodes[i],(compcxx_component::SimpleChannel_to_phy_f_t)&compcxx_SensorNode_19::from_channel) /*connect channel.to_phy[i],nodes[i].from_channel */;
    }

}


#line 173 "sim_80211.cc"
int main(int argc, char* argv[])
{
    compcxx_Sim_80211_21 sim;
